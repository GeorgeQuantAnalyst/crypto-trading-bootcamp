...
* [UNI](https://uniswap.org/):  UNI is the native token of Uniswap, one of the most popular decentralized exchanges. UNI is used as a governance token, allowing holders to vote on protocol changes and upgrades.
